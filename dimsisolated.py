...
dimension_values = [2,3,4]
for c in dimension_values:
    plt.figure(figsize=(10, 6))

    cfiltered_df = df[(df['Dimensions'] == c)]
    ...
    plt.title(f'Percentage True Winner Reached by Ballot Length Dimensions: {c}')
    ...
    final_df.to_csv(f'{c}_dimensions_isolated.csv', index=False)